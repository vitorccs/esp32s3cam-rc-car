...
// ESP32S3-CAM, the unofficial successor of the ESP32-CAM AI Thinker.
// It uses the standard ESP32-S3 camera pinout (same as the Freenove board),
// only the motor/LED GPIOs differ (see Config.h).
